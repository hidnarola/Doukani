                                ...
                                <div class='col-sm-12'>
                                    <div class='page-header'>
                                        ...
                                        <div class='pull-right'>
                                            <a class="btn" href="<?php echo base_url() . "admin/custom_banner/CustomBanner/11"; ?>"><i class="icon-list"></i> Custom Banner List</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class='box'>
                                        ...
                                        <div class='box-content'>
                                            <form enctype="multipart/form-data" action="" method="post" name="category" class="validate-form form-horizontal" style="margin-bottom: 0;"  accept-charset="UTF-8">
                                                ...
                                                <div class='form-group'>
                                                    <label class='col-md-2 control-label' for='inputText'>Advertiser</label>
