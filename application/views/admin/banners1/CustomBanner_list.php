                                ...
                                <div class='col-sm-12'>
                                    <div class='page-header'>
                                        ...
                                        <div class='pull-right'>
											<a class="btn" href="<?php echo base_url() . "admin/custom_banner/CustomBanner/11"; ?>">
                                                <i class="fa fa-refresh"></i> Reset Filters
                                            </a>
											&nbsp;&nbsp;&nbsp;
                                            <a class="btn " href="<?php echo base_url() . "admin/custom_banner/addcustom/11"; ?>">
                                                <i class="icon-plus"></i> Add Custom Banner
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class='row'>
                                <div class='col-sm-4'>
                                    <div class='box bordered-box orange-border' style='margin-bottom:0;'>
										...
										<form id="form1" name="form1" action="<?php echo site_url().'admin/custom_banner/CustomBanner/11'; ?>" method="get" accept-charset="UTF-8">
                                        <div class='box-content '><?php echo $this->uri->segment(5); ?>
                                                                ...
                                                                if (!empty($superCategories)) {
                                                                    foreach ($superCategories as $superCategory) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td  align="center">
                                                                                <a class="btn btn-warning btn-xs has-tooltip" title="Edit" data-placement='top' href="<?php echo base_url(); ?>admin/custom_banner/editcustom/11/<?php echo $superCategory['ban_id']; ?>"><i class="icon-edit"></i></a>
                                                                   
																				<a class="btn btn-danger btn-xs has-tooltip" title="Delete" data-placement='top' href="<?php echo base_url(); ?>admin/custom_banner/deletecustom/11/<?php echo $superCategory['ban_id']; ?>" onclick="return confirm('Are you sure you want to delete this record ?');"><i class="icon-trash"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                        <?php
                                                                    }
...
<script>
                                                function show_banner(banid,name) {
                                                    ...
                                                    $.post(url, {type: 11, name: name}, function(data)
                                                    {
//                                    alert(data);
