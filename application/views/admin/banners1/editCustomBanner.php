                                ...
                                <div class='col-sm-12'>
                                    <div class='page-header'>
                                        ...
                                        <div class='pull-right'>
                                            <div class="btn-group">
                                                <a class="btn " style="margin-right: 5px;" href="<?php echo base_url() . "admin/custom_banner/CustomBanner/11"; ?>"><i class="icon-list"></i> Custom Banner List</a>
                                                <a class="btn " href="<?php echo base_url() . "admin/custom_banner/addcustom/11"; ?>"><i class="icon-plus"></i> Add Custom Banner</a>
                                            </div>											
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <form enctype="multipart/form-data" action="" method="post" name="category" class="validate-form  form-horizontal" style="margin-bottom: 0;"  accept-charset="UTF-8">
												<div class='form-group'>
													...
													<div class='col-md-10'>
														...
														<label class='radio radio-inline'>
															<input type="radio" class="web" name="ban_show_status" id="web" value="web" <?php echo ($bannerInfo[0]->ban_show_status == "web") ? "checked" : ""; ?> />Web
														</label>
                                                ...
                                                if ($bannerInfo[0]->ban_txt_img == "text") {
                                                    ...
                                                    <div class='form-group' id="text_1">
                                                        ...
                                                        <div class='col-md-5'>
                                                            <textarea rows="5"  name="" class="form-control" style="direction:ltr; text-align:left; "><?php echo $bannerInfo[0]->text_val; ?></textarea>
                                                        </div>
                                                    </div>
                                                    <?php
                                                } else if ($bannerInfo[0]->ban_txt_img == "image") {
                                                    ?>
                                                    <div class='form-group' id="img_2" style="<?php if($bannerInfo[0]->ban_txt_img == "image" || $bannerInfo[0]->img_file_name != "" ) echo ''; else echo 'display:none;' ?>" >
                                                        ...
                                                        <div class='col-md-9'>																
                                                            ...
                                                            if ($bannerInfo[0]->big_img_file_name != "") {
                                                                echo "<img class='img-responsive' src='" . base_url() . banner . "medium/" . $bannerInfo[0]->big_img_file_name . "' /><br>";
                                                            }
                                                            ?>																
                                                            <div class='col-md-5'>
													 ...
													 <div class='form-group' id="img_2" style="<?php if($bannerInfo[0]->ban_txt_img == "image" || $bannerInfo[0]->img_file_name != "" ) echo ''; else echo 'display:none;' ?>" >
                                                        ...
                                                        <div class='col-md-9'>
                                                            ...
                                                            if ($bannerInfo[0]->img_file_name != "") {
                                                                echo "<img class='img-responsive' src='" . base_url() . banner . "medium/" . $bannerInfo[0]->img_file_name . "' /><br>";
                                                            }
                                                            ?>
                                                            <div class='col-md-5'>
                                                    ...
                                                    <div class='form-group' id="site_url_hide" style="<?php if($bannerInfo[0]->site_url!='') echo '';
                                                ...
                                                <div class='form-group' id='start_dt' >
                                                    ...
                                                    <div class='col-md-5'> <!-- datepicker-->
                                                        <div class='datetimepicker input-group input-group' id='datepicker'>
                                                            <!--<input class='form-control' data-format='yyyy-MM-dd' name="ex_st_dt" id="ex_st_dt" placeholder='Select datepicker' type='text' value="<?php //echo $bannerInfo[0]->expiry_start_date; ?>"> -->
															<input class='form-control' data-format='yyyy-MM-dd' name="ex_st_dt" id="ex_st_dt" placeholder='Select Start Date' type='text' value="<?php echo $bannerInfo[0]->expiry_start_date; ?>">
                                                ...
                                                <div class='form-actions form-actions-padding-sm' id="finalRow">
                                                    <div class='row'>
                                                        <div class='col-md-10 col-md-offset-2'>
                                                            ...
                                                            <a  href='<?php echo base_url(); ?>admin/custom_banner/CustomBanner/11' title="Cancel" class="btn ">Cancel</a>
                                                        </div>
                                                    </div>
                                                </div>
