                                    ...
                                    <div class='box-content'>
                                        ...
                                        <form action='<?php echo base_url() . 'admin/users/edit_store_request/' . $store_request_details['id']; ?>' class='form form-horizontal validate-form' accept-charset="UTF-8" method='post' enctype="multipart/form-data" id="store_edit">
                                            ...
                                            <div class='form-group'>
                                                ...
                                                <div class='col-md-5 controls'>
                                                    <input placeholder='Store Domain' class="form-control" name="store_domain" id="store_domain" type='text' value="<?php echo $store_request_details['store_domain']; ?>" data-rule-required='true' onkeypress="return isNumber1(event);" maxlength="15">
