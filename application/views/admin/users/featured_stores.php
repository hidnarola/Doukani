...
<html>
    ...
    <body class='contrast-fb store'>
                    ...
                    <div class='row' id='content-wrapper'>
                        <div class='col-xs-12'>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class='title'>
                                        <h5><span class="f_label" >F</span> - Featured Stores Running in Front End</h5>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                            ...
                                            <div class='responsive-table'>
                                                <div class='scrollable-area table-responsive'>
                                                    <table class='table table-striped superCategoryList' style='margin-bottom:0;'>
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            if (isset($featured_stores) && sizeof($featured_stores) > 0):
                                                                foreach ($featured_stores as $pro) {
                                                                    ?>
                                                                    <tr>
                                                                        <td><input class="input-sm" type="checkbox"  style="height: 16px;" value="<?php echo $pro['store_id']; ?>" /></td> 
                                                                        <td>
            ...
            <div class="modal fade sure" id="deleteConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">                  
                            <p>Are you sure you want to make Store(s) as Un-featured?</p>
                        </div>
        ...
        <script>
            ...
            $(document).on("click", "#unfeatured_store", function (e) {
                ...
                if ($('#checked_val').val() != '') {
                    if (selectedValue == 'unfeatured') {
                        ...
                        $(document).on("click", ".yes_i_want_delete", function (e) {
                            var val = $(this).val();
                            if (val == 'yes') {
                                jQuery('#userForm').attr('action', "<?php echo base_url(); ?>admin/users/update_unfeatured").submit();
                            }
                        });
                    } else {
                        $("#alert").modal('show');
