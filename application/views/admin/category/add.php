                                            ...
                                            <div class='form-group'>                        
                                                ...
                                                <div class='col-md-5'>                                                    
                                                    <label class="checkbox-inline">
                                                        <input id="inlineCheckbox1" type="checkbox" value="0" name="category_type[]" data-rule-required='true'>
                                                        Classified Products
                                                    </label>
                                                    <label class="checkbox-inline">
                                                        <input id="inlineCheckbox2" type="checkbox" value="1" name="category_type[]">
                                                        Store Products
                                                    </label>
                                                    <label class="checkbox-inline">
                                                        <input id="inlineCheckbox3" type="checkbox" value="2" name="category_type[]">
                                                        Offer Products
                                                    </label>                                                    
                                                </div>
                                            </div>
