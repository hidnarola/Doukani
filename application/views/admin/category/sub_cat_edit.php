                                        ...
                                        <form action='<?php echo base_url() . 'admin/classifieds/subCategories_edit/' . $category[0]->sub_category_id; ?>' class='form form-horizontal validate-form' accept-charset="UTF-8" method='post' enctype="multipart/form-data" id="form">
                                            ...
                                            <?php if (!empty($category[0]->sub_category_image)): ?>
                                                <div class='form-group'>
                                                    ...
                                                    <div class='col-md-5'>
                                                        <img alt="category Image" src="<?php echo base_url() . category . "medium/" . $category[0]->sub_category_image; ?>" onError="this.src='<?php echo base_url() . 'assets/upload/No_Image.png' ?>'" alt="Image" />
                                                ...
                                                <div class='col-md-5'>                                                    
                                                    <?php if (isset($category_types) && in_array(0, $category_types)) { ?>
                                                        <label class="checkbox-inline">
                                                            <input id="inlineCheckbox1" type="checkbox" value="0" name="sub_category_type[]" data-rule-required='true' <?php echo (in_array(0, explode(',', $category[0]->sub_category_type))) ? 'checked=checked' : ''; ?>>
                                                            Classified Products
                                                        </label>
                                                    <?php } if (isset($category_types) && in_array(1, $category_types)) { ?>
                                                        <label class="checkbox-inline">
                                                            <input id="inlineCheckbox2" type="checkbox" value="1" name="sub_category_type[]" <?php echo (in_array(1, explode(',', $category[0]->sub_category_type))) ? 'checked=checked' : ''; ?>>
                                                            Store Products
                                                        </label>
                                                    <?php }
//                                                    if (isset($category_types) && in_array(2, $category_types)) { 
                                                    ?>
                                                    <!--                                                        <label class="checkbox-inline">
                                                                                                                <input id="inlineCheckbox3" type="checkbox" value="2" name="sub_category_type[]" <?php echo (in_array(2, explode(',', $category[0]->sub_category_type))) ? 'checked=checked' : ''; ?>>
                                                                                                                Offer Products
                                                                                                            </label>-->
                                                    <?php // } ?>
                                                </div>
