                ...
                <div class='container'>
                    <div class='row' id='content-wrapper'>
                        <div class='col-xs-12'>
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class='pull-right'>
                                            <?php if (isset($_REQUEST['userid']) && !empty($_REQUEST['userid'])) { ?>
                                                <a href='<?php echo site_url() . 'admin/classifieds/repost_ads/' . $this->uri->segment(4) . '/?userid=' . $_REQUEST['userid']; ?>'  title="Reset Filter" class="btn">
                                                    <i class="fa fa-refresh"></i>&nbsp;Reset Filters
                                                </a>
                                            <?php } else { ?>
                                                <a href='<?php echo site_url() . 'admin/classifieds/repost_ads/' . $this->uri->segment(4); ?>'  title="Reset Filter" class="btn">
                                                    <i class="fa fa-refresh"></i>&nbsp;Reset Filters
                                                </a>
                                            <?php } ?>
                                        </div>
                            ...
                            <?php endif; ?>
                            <form id="form1" name="form1" action="<?php echo site_url() . 'admin/classifieds/repost_ads/' . $this->uri->segment(4); ?>" method="get" accept-charset="UTF-8">
                                <?php if (isset($_REQUEST['userid']) && !empty($_REQUEST['userid'])) { ?>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="box bordered-box orange-border" style="margin-bottom:0;">
                                            ...
                                            <div class="box-content ">
                                                ...
                                                <div id="date_range">
                                                    <input  id="date_range_val" class='form-control daterange input-group' data-format='yyyy-MM-dd' placeholder='Product Re-Posted Date' type='text' value="<?php if (isset($_REQUEST['dt'])) echo $_REQUEST['dt']; ?>" name="dt" >
                ...
                <div class="modal-content rounded">
                    ...
                    <div class="modal-body">
                        <div class="FeaturedAds-popup">
                            <form action='<?php echo base_url(); ?>admin/classifieds/insert_featured' class='form form-horizontal validate-form' accept-charset="UTF-8" method='post' id="featured_form">
                                <div class='box-content control'>
                                    ...
                                    <a class='btn btn-primary' href="#" onclick="javascript:insert_featured();">
                                        ...
                                        <input type='hidden' name="repost" id="repost" value="repost">
