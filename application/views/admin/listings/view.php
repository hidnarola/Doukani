            ...
            <section id='content'>
                <div class='container'>
                    ...
                    <div class='form-group'>                        
                        ...
                        <div class='col-md-5 controls'>
                            <input class="form-control"  placeholder="Total Likes" value="<?php if(isset($product[0]['product_total_likes'])) echo $product[0]['product_total_likes']; ?>" type="text" />
                        </div>
                    </div>
                    <div class='form-group'>                        
                        <label class='col-md-2 control-label' for='inputText1'>Total Favorites</label>
                        <div class='col-md-5 controls'>
                            <input class="form-control"  placeholder="Total Favorites" value="<?php if(isset($product[0]['product_total_favorite'])) echo $product[0]['product_total_favorite']; ?>" type="text" />
                        </div>
                    </div>
