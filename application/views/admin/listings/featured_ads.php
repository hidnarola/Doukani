                                            ...
                                            <div class='responsive-table'>
                                                <div class='scrollable-area'>
                                                    <table class='table table-striped superCategoryList' style='margin-bottom:0;'>
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            if (isset($featured_ads) && sizeof($featured_ads) > 0):
                                                                foreach ($featured_ads as $pro) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        if ($admin_permission == 'only_listing') {
                                                                            ...
                                                                            ?>
                                                                            <td><input class="input-sm" type="checkbox"  style="height: 16px;" value="<?php echo $pro['id']; ?>" /></td> 
                                                                        <?php } ?>
                                                                        <td>
                                                                            <?php if ($pro['my_status'] == 'running') { ?>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            if (!empty($pro['product_image'])) {
                                                                                ...
                                                                                $img_url = base_url() . product . "small/" . $pro['product_image'];
                                                                            } else {
                                                                            ...
                                                                            <a data-lightbox='flatty' href='<?php echo $load_image; ?>'>
                                                                                <img alt="Category Image" style="height: 40px; width: 64px;" src="<?php echo $img_url; ?>" onerror="this.src='<?php echo site_url(); ?>/assets/upload/No_Image.png'"/>
                                                                            </a>						
                                                                        </td>
                                                                        <td>
                                                                            <?php
                                                                            ...
                                                                            <td>
                                                                                <div class="btn-group action_drop_down">
                                                                                    ...
                                                                                    <ul class="dropdown-menu" role="menu">
                                                                                        <li>
                                                                                            <a id="un_featured_ad" data-id="<?php echo $pro['id']; ?>">
        ...
        <script>
            ...
            $(document).on("click", "#un_featured_ad", function (e) {
                ...
                $(document).on("click", ".yes_i_want_delete", function (e) {
                    var val = $(this).val();
                    if (val == 'yes') {
                        jQuery('#userForm').attr('action', "<?php echo base_url(); ?>admin/classifieds/update_unfeatured/" + featured_id).submit();
                    }
                });
            });
                ...
                if ($('#checked_val').val() != '') {
                    if (selectedValue == 'unfeatured') {
                        ...
                        $(document).on("click", ".yes_i_want_delete", function (e) {
                            var val = $(this).val();
                            if (val == 'yes') {
                                jQuery('#userForm').attr('action', "<?php echo base_url(); ?>admin/classifieds/update_unfeatured").submit();
                            }
                        });
                    } else {
                        $("#alert").modal('show');
