                            ...
                            <div class='row'>
                                <div class='col-sm-12 box'>
                                    ...
                                    <div class='box-content'>
                                        <form action='<?php echo base_url() . 'admin/classifieds/featuredad_price' ?>' class='form form-horizontal validate-form' accept-charset="UTF-8" method='post'>
                                            ...
                                            <div class="form-actions form-actions-padding-sm">
                                                <div class="row">
                                                    <div class="col-md-8 col-md-offset-3">
                                                        ...
                                                        <a href='<?php echo base_url(); ?>admin/classifieds/featuredad_price' title="Cancel" class="btn">Cancel</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
