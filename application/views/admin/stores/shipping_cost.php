                        ...
                        <div class='col-xs-12'>
                            <div class='page-header page-header-with-buttons'>
                                <h1 class='pull-left'>
                                    ...
                                    <?php
                                    if (isset($store_details) && isset($store_details[0])) {
                                        echo $store_details[0]->store_name . ' Store\'s Shipping Cost';
                                    }
                                    ?>
                                </h1>               
                            </div>
...
<!--                                            <form action='<?php echo base_url() . 'admin/users/store_shipping_cost/' . $lastUriSegment ?>' class='form form-horizontal validate-form' accept-charset="UTF-8" method='post'>
        ...
        <div class='form-group'>
            ...
            <div class='col-md-3 controls'>
                ...
                <input class="form-control original_price" placeholder="Price" name="price_1" type="text" value="<?php
                                        if (in_array(1, $lbl_id)) {
                                            echo $offerArray[1];
                                        }
                                        ?>" required="" />            
            </div>
        ...
        <div class='form-group'>
            ...
            <div class='col-md-3 controls'>
                ...
                <input class="form-control original_price" placeholder="Price" name="price_2" type="text" value="<?php
                                        if (in_array(2, $lbl_id)) {
                                            echo $offerArray[2];
                                        }
                                        ?>" required="" />            
            </div>
         ...
         <div class='form-group'>
            ...
            <div class='col-md-3 controls'>
                ...
                <input class="form-control original_price" placeholder="Price" name="price_3" type="text" value="<?php
                                        if (in_array(3, $lbl_id)) {
                                            echo $offerArray[3];
                                        }
                                        ?>" required="" />            
            </div>
        ...
        <div class='form-group'>
            ...
            <div class='col-md-3 controls'>
                ...
                <input class="form-control original_price" placeholder="Price" name="price_4" type="text" value="<?php
                                        if (in_array(4, $lbl_id)) {
                                            echo $offerArray[4];
                                        }
                                        ?>" required="" />            
            </div>
        ...
        <div class='form-group'>
            ...
            <div class='col-md-3 controls'>
                ...
                <input class="form-control original_price" placeholder="Price" name="price_5" type="text" value="<?php
                                        if (in_array(5, $lbl_id)) {
                                            echo $offerArray[5];
                                        }
                                        ?>" required="" />            
            </div>
        ...
        <div class='form-group'>
            ...
            <div class='col-md-3 controls'>
                ...
                <input class="form-control original_price" placeholder="Price" name="price_6" type="text" value="<?php
                                        if (in_array(6, $lbl_id)) {
                                            echo $offerArray[6];
                                        }
                                        ?>" required="" />            
            </div>
        ...
        <div class='form-group'>
            ...
            <div class='col-md-3 controls'>
                ...
                <input class="form-control original_price" placeholder="Price" name="price_7" type="text" value="<?php
                                        if (in_array(7, $lbl_id)) {
                                            echo $offerArray[7];
                                        }
                                        ?>" required="" />            
            </div>
         ...
         <div class='form-group'>
            ...
            <div class='col-md-3 controls'>
                ...
                <input class="form-control original_price" placeholder="Price" name="price_8" type="text" value="<?php
                                        if (in_array(8, $lbl_id)) {
                                            echo $offerArray[8];
                                        }
                                        ?>" required="" />            
            </div>
        ...
        <div class='form-group'>
            ...
            <div class='col-md-3 controls'>
                ...
                <input class="form-control original_price" placeholder="Price" name="price_9" type="text" value="<?php
                                        if (in_array(9, $lbl_id)) {
                                            echo $offerArray[9];
                                        }
                                        ?>" required="" />            
            </div>
        ...
        <div class='form-group'>
            ...
            <div class='col-md-3 controls'>
                ...
                <input class="form-control original_price" placeholder="Price" name="price_10" type="text" value="<?php
                                        if (in_array(10, $lbl_id)) {
                                            echo $offerArray[10];
                                        }
                                        ?>" required="" />            
            </div>
