            ...
            <section id='content'>
                <div class='container'>
                    ...
                    <div class='row' id='content-wrapper'>
                        ...
                        ?>
                        <div class='col-xs-12'>
                            <form id="form1" name="form1" action="<?php echo site_url() . 'admin/custom_banner/CustomBanner/11/' . $banner_for; ?>" method="get" accept-charset="UTF-8">
                                <div class='row'>
                                    <div class='col-sm-12'>
                                        <div class='page-header'>
                                            ...
                                            <div class='pull-right'>
                                                <a class="btn " href="<?php echo base_url() . "admin/custom_banner/addcustom/11/" . $banner_for; ?>">
                                                    <i class="icon-plus"></i> Add Custom Banner
                                                </a>
                                                &nbsp;&nbsp;&nbsp;
                                                <a class="btn" href="<?php echo base_url() . 'admin/custom_banner/CustomBanner/11/' . $banner_for; ?>">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if (isset($superCategories) && sizeof($superCategories) > 0) {
                                                                        foreach ($superCategories as $superCategory) {
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <input class="input-sm" type="checkbox"  style="height: 16px;" value="<?php echo $superCategory['ban_id']; ?>" />
                                                                                </td>
                                                                                ...
                                                                                <td>
                                                                                    <div class="btn-group action_drop_down">
                                                                                        ...
                                                                                        <ul class="dropdown-menu" role="menu">
                                                                                            <li>
                                                                                                <a href="<?php echo base_url(); ?>admin/custom_banner/editcustom/11/<?php echo $banner_for . '/' . $superCategory['ban_id'] . $redirect; ?>"><i class="icon-edit"></i> Edit Banner</a>
                                                                                            </li>
                                                                                            <li class="divider"></li>
                                                                                            <li>
                                                                                                <?php
                                                                                                $redirect_after_delete = base_url() . 'admin/custom_banner/deletecustom/11/' . $banner_for . '/' . $superCategory['ban_id'] . '/';
        ...
        if ($('#checked_val').val() != '') {
            if (selectedValue == 'delete') {
                ...
                $(document).on("click", ".yes_i_want_delete", function (e) {
                    var val = $(this).val();
                    if (val == 'yes') {
                        jQuery('#userForm1').attr('action', "<?php echo base_url(); ?>admin/Custom_banner/deletecustom").submit();
                    }
                });
            } else {
                $("#alert").modal('show');
