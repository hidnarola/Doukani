                                    ...
                                    <div class='page-header'>
                                        ...
                                        <div class='pull-right'>
                                            ...
                                            if ($this->uri->segment(5) != '')
                                                ...
                                                $banner_for = '';
                                            ?>
                                            <a class="btn" href="<?php echo base_url() . "admin/custom_banner/CustomBanner/11/" . $banner_for; ?>"><i class="icon-list"></i> Custom Banner List</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class='box-content'>
                                            <form enctype="multipart/form-data" action="" method="post" name="category" class="validate-form form-horizontal" style="margin-bottom: 0;"  accept-charset="UTF-8">
                                                <div class='form-group' style="display:none;">
                                                    ...
                                                    <div class='col-md-5'>
                                                        <select name="ban_for" id="ban_for" class='form-control' onload="get_banner_type(this.value)">
                                                ...
                                                <div class='form-group' id="big_img" style="display:none;">
                                                    ...
                                                    <div class='col-md-3'>                                                           
                                                        <input type="file" name="uploadedlargefile" id="uploadedlargefile"  onchange="javascript:loadimage(this);" class='form-control'>
                                                    </div>
                                                    <br><br><br><br>
                                                ...
                                                <div class='form-group'>
                                                    <label class='col-md-2 control-label' for='inputText'>Advertiser<span>*</span></label>
                                                ...
                                                <div class='form-actions form-actions-padding-sm' id="finalRow">
                                                    <div class='row'>
                                                        <div class='col-md-10 col-md-offset-2'>
                                                            ...
                                                            <a  href='<?php echo base_url(); ?>admin/custom_banner/CustomBanner/11/<?php echo $banner_for; ?>' title="Cancel" class="btn ">Cancel</a>
                                                        </div>
                                                    </div>
                                                </div>
