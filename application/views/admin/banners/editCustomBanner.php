                                ...
                                <div class='col-sm-12'>
                                    <div class='page-header'>
                                        ...
                                        <div class='pull-right'>
                                            ...
                                            ?>
                                            <div class="btn-group">
                                                <a class="btn " style="margin-right: 5px;" href="<?php echo base_url() . "admin/custom_banner/CustomBanner/11/" . $banner_for; ?>"><i class="icon-list"></i> Custom Banner List</a>
                                                <a class="btn " href="<?php echo base_url() . "admin/custom_banner/addcustom/11/" . $banner_for; ?>"><i class="icon-plus"></i> Add Custom Banner</a>
                                            </div>											
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class='col-sm-12'>
                                    <div class='box'>
                                        ...
                                        <div class='box-content'>
                                            <form enctype="multipart/form-data" action="<?php site_url() . 'custom_banner/editcustom/11/web/' . $redirect; ?>" method="post" name="category" class="validate-form  form-horizontal" style="margin-bottom: 0;"  accept-charset="UTF-8">
...
<?php if ($dip_pg1 != '' && ($dip_pg1 == 'header' || $dip_pg1 == 'between' || $dip_pg1 == 'sidebar')) { ?>
                                                        ...
                                                        if ($bannerInfo[0]->ban_txt_img == "image") {
                                                            ...
                                                            if ($bannerInfo[0]->ban_txt_img == "image" || $bannerInfo[0]->img_file_name != "")
                                                                echo '';
                                                            else
                                                                echo 'display:none;'
                                                                ?>" >
                                                                <label class='col-md-2 control-label' for=''></label>
                                                                <div class='col-md-9'>
                                                                    <?php if ($bannerInfo[0]->big_img_file_name != "") { ?>
                                                        ...
                                                        <?php if ($bannerInfo[0]->ban_txt_img == "image") { ?>
                                                            ...
                                                            if ($bannerInfo[0]->ban_txt_img == "image" || $bannerInfo[0]->img_file_name != "")
                                                                ...
                                                                <div class='col-md-9'>
                                                                    ...
                                                                    <?php if ($bannerInfo[0]->img_file_name != "") { ?>
                                                ...
                                                <div class='form-group'>
                                                    ...
                                                    <div class='col-md-5 controls'>
                                                        <input type="number" name="impression_day" size="10" class="form-control" value="<?php echo $bannerInfo[0]->impression_day; ?>" data-rule-required='true'/>
                                                ...
                                                <div class='form-group'>
                                                    <label class='col-md-3 control-label' for='inputText1'>
                                                    </label>                                                    
                                                </div>
                                                <div class='form-group'>
                                                    <label class='col-md-2 control-label' for='inputText'>Clicks<span>*</span></label>
                                                    <div class='col-md-5 controls'>
                                                        <input type="number" name="clicks_day" size="10" class="form-control" value="<?php echo $bannerInfo[0]->clicks_day; ?>" data-rule-required='true'/>
                                                    </div>
                                                    <div class='col-md-6 controls'>
                                                        <label class='control-label' for='inputText'>
                                                ...
                                                <div class='form-actions form-actions-padding-sm' id="finalRow">
                                                    <div class='row'>
                                                        <div class='col-md-10 col-md-offset-2'>
                                                            ...
                                                            <a  href='<?php echo base_url(); ?>admin/custom_banner/CustomBanner/11/<?php echo $banner_for . $redirect; ?>' title="Cancel" class="btn ">Cancel</a>
                                                        </div>
                                                        <input type="hidden" id="total" name="total" 
                                                               value="<?php echo (isset($catt_arr)) ? count($catt_arr) - 1 : ''; ?>" />
                                                        <input type="hidden" id="store_total" name="store_total" value="<?php echo (isset($store_arr)) ? count($store_arr) - 1 : ''; ?>" />
                                                        <input type="hidden" id="company_total" name="company_total" value="<?php echo (isset($company_arr)) ? count($company_arr) - 1 : ''; ?>" />
                                                    </div>
                                                </div>                                                
                                            </form>
                                        </div>
