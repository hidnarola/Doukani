...
<?php if(isset($product_view) && $product_view=='list'){ 
...
<script>
    ...
    function load_more_jquerylisting() {
        ...
        if(load_more_status1=='false') {
            $.post(url, {value: val1, user_id: user_id,product_view:product_view,type:type, user_status:'<?php echo $user_status; ?>',state_id_selection:state_id_selection}, function (response)
            {
