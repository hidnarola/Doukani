<?php
    if (sizeof($stores) > 0) {
        ...
        foreach ($stores as $st) {
            ...
            $profile_picture = $this->dbcommon->load_picture($st['profile_picture'], $st['facebook_id'], $st['twitter_id'], $st['username'], $st['google_id'], 'original');
        ...
        <?php } ?>
                        ...
                        <div class="store-name"><a  href="<?php echo $store_link; ?>" rel="nofollow"><h3><?php echo $st['store_name']; ?></h3></a></div>
                    </div>
                </div>
            </div>
    <?php }
