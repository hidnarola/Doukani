...
if (sizeof($stores) > 0) {
    ...
    foreach ($stores as $st) {
        ...
        $store_cover_img = '';
        $store_start = thumb_start_grid_store_cover . HTTP . website_url;
        ...
        if ($st['store_cover_image'] != '')
            ...
            $store_cover_img = $store_start . HTTP . website_url . 'assets/upload/store_cover_image.png' . $store_end;

        $profile_picture = '';

        $profile_start = thumb_start_grid . HTTP . website_url;
...
<?php if (@$hide == "false") { ?>
    <div class="col-sm-12 text-center" id="load_moresearch">
        <button class="btn btn-blue" onclick="load_more_jquerylisting();" id="load_storesearch" value="0">Load More</button><br><br><br>
    </div>
<?php } ?>