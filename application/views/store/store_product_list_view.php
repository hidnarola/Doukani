            ...
            <div class="list-item">                
                <div class="col-sm-3 img-holder">
                    ...
                    <div class="col-sm-9 info-holder">
                        <div class="row">
                            <div class="col-sm-8">
                                <a style="text-decoration: none;" href="<?php echo $store_url . $pro['product_slug']; ?>"><h3><?php echo $pro['product_name']; ?></h3></a>
                    ...
                    <?php } else { ?>
                                                ...
                                                ?>
                                                <div class="star" ><a href="<?php echo $store_url . 'login/index'; ?>">
                    ...
                    <?php } else { ?>
                                                ...
                                                ?>
                                                <div class="newthumb" ><a href="<?php echo $store_url . 'login/index'; ?>">
                        ...
                        <div class="Viewouterbutton">
                            <a href="<?php echo $store_url . $pro['product_slug']; ?>" class="btn mybtn">View</a>
                        </div>
                    </div>
                </div>
            </div>
