            ...
            <div class="item-sell">
                <div class="item-img-outer">
                    <div class="item-img">
                        ...
                        <?php } else { ?>
                            <a href="<?php echo $store_url . $pro['product_slug']; ?>"><img src="<?php echo thumb_start_grid . HTTPS . website_url; ?>assets/upload/No_Image.png<?php echo thumb_end_grid; ?>" class="img-responsive" alt="<?php echo $pro['product_name']; ?>" /></a>
                        <?php } ?>
                    </div>
