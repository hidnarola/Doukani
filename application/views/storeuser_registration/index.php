                    ...
                    <div class="row">          
                        ...
                        <div class="col-sm-12 main category-grid">	
                            ...
                            <div class="col-sm-9 ContentRight loginpg">
                                ...
                                <form  name="registration" id="registration" action='<?php echo base_url(); ?>storeRegistration/index' method='post' enctype="multipart/form-data">
                                    <div class="col-sm-12 login-div regi-div">
                                        <!--<div class="user-login">-->
                                        <div class="classified-registration">
                                            <?php
                                            $url = "";
                                            ...
                                            <div class="form-group store_hide_show_div">   
                                                <div class="col-lg-6 margin-bottom">

                                                    <input type="text" class="form-control" placeholder="Store Name" name="store_name" id="store_name" value="<?php
                                                    if ($this->session->userdata('store_name_create')) {
                                                        echo $this->session->userdata('store_name_create');
                                                    }
                                                    ?>" />
                                            ...
                                            <div class="agree">    
                                                <input type="checkbox" class="term_condition" name="term_condition" id="term_condition" checked value="1">  Yes, I agree with <a href="<?php echo site_url() . $term_link->slug_url; ?>" target="_blank"><span><?php echo $term_link->page_title; ?></span></a>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="">
                                                    <button type="submit" name="register" id="register" class="btn btn-block btn-black">Register</button>
                                                    <div class="text-center signup-link"><a href="<?php echo base_url(); ?>login/index">Already Registered? <span>Log In</span></a></div>
                                                </div>
                                            </div>
                                        </div>	                                                
                                    </div>
