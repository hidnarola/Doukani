...
if (!empty($product_data)) {
    foreach ($product_data as $pro) {
        ...
        ?> 
        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 <?php if (isset($favorite_ads) && $favorite_ads == 'yes') { ?> prod_<?php  echo $pro['product_id']; } if((isset($home_page) && $home_page=='yes') || (isset($latest_page) && $latest_page=='yes')) echo 'home_items' ?>">
            <div class="item-sell <?php if ((isset($featured_data) && $featured_data == 'yes') || (isset($pro['featured_ad']) && $pro['featured_ad'] > 0)) echo 'featured-sell'; ?> <?php if (isset($my_listing) && $my_listing == 'yes' && $pro['product_is_sold'] != 1) { ?>edit-div<?php } ?> item-sell<?php echo $pro['product_id']; ?>">
                <div class="item-img-outer">
                    ...
                    ?>
        <?php if ((isset($featured_data) && $featured_data == 'yes') || (isset($pro['featured_ad']) && $pro['featured_ad'] > 0)) { 
        ...
        <?php if (!empty($pro['product_image'])) { ?>
                                <a href="<?php echo $product_path; ?>"><img src="<?php echo thumb_start_grid . base_url() . product . "medium/" . $pro['product_image'] . thumb_end_grid; ?>" class="img-responsive" 
                                                                            onerror="this.src='<?php echo thumb_start_grid . base_url(); ?>assets/upload/No_Image.png<?php echo thumb_end_grid; ?>'" alt="<?php echo $pro['product_name']; ?>"  /></a>
                            <?php } else { ?>                                            
                                <a href="<?php echo $product_path; ?>"><img src="<?php echo thumb_start_grid . base_url(); ?>assets/upload/No_Image.png<?php echo thumb_end_grid; ?>" class="img-responsive" alt="<?php echo $pro['product_name']; ?>" /></a>
                        <?php } ?>
                        </div>
                        <?php
                                ...
                                <div class="edit_option"><i class="fa fa-pencil-square-o"></i>
                                    <div class="tip">
                                        ...
                                        <ul class="options_list">  
                                            ...
                                            ?>												
                                            <li id="mynew1<?php echo $pro['product_id']; ?>"><a href="javascript:void(0);" onclick="javascript:deleteproduct('<?php echo $pro['product_id']; ?>');"><i><img src="<?php echo site_url(); ?>assets/front/images/delete.png" alt="Image" ></i>Delete</a></li>
                                            <?php if (!isset($_REQUEST['val']) || $_REQUEST['val'] == 'Approve') { ?>
                                                <li id="mynew1<?php echo $pro['product_id']; ?>"><a href="javascript:void(0);" id="boost" ><i><img src="<?php echo site_url(); ?>assets/front/images/boost.png" alt="Image" ></i>Promote My Item</a>
                    ...
                    <div class="cat_grid">
                        ...
                        if ((isset($seller_listing_page) && $seller_listing_page == 'yes') || (isset($my_listing) && $my_listing == 'yes') || (isset($my_deactivateads) && $my_deactivateads == 'yes')) {
                            ...
                            <div class="by-user">
                                ...
                                ?>
                                <img src="<?php echo $profile_picture; ?>" class="img-responsive img-circle" onerror="this.src='<?php echo base_url(); ?>assets/upload/avtar.png'" alt="Image"  />
                                <?php
                                if (isset($pro['product_for']) && $pro['product_for'] == 'store' && isset($pro['store_domain']) && !empty($pro['store_domain']))
