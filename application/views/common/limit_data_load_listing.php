...
if (!empty($product_data)) {
                ...
                <div class="col-sm-3 img-holder">
                    ...
                    <div class="red_ribbon"></div> <?php }} ?>
                        <div class="img-holderInner">
                            ...
                            <?php } else { ?>
                                <img src="<?php echo thumb_start_grid . base_url(); ?>assets/upload/No_Image.png<?php echo thumb_end_grid; ?>" class="img-responsive" alt="<?php echo $pro['product_name']; ?>" />
                            <?php } ?>
                        </div>
                        <?php if (isset($pro['featured_ad']) && $pro['featured_ad'] > 0) {
                            if (isset($latest_page) && $latest_page == 'yes') { } else {
                    ...
                    <div class="col-sm-9 info-holder">			
                        <div class="row">
                            <div class="col-sm-8">
                                <a style="text-decoration: none;" href="<?php echo base_url() . $pro['product_slug']; ?>"><h3 title="<?php echo $pro['product_name']; ?>"><?php echo $pro['product_name']; ?></h3></a>
        ...
        <?php } ?>
                        ...
                        if (isset($seller_listing_page) && $seller_listing_page == 'yes') {
                            ...
                            <div class="by-user">
                                ...
                                <a href="<?php echo base_url() . emirate_slug . $pro['user_slug'].$view_req; ?>"><?php echo $pro['username1']; ?></a>                                           
                            </div>
        <?php } ?>
    ...
    <script>
        $(document).ready(function () {
            var w = $('.horizontalList .img-holder').width();
            $('.horizontalList .img-holder .img-holderInner').css('width', w);
            var h = $('.horizontalList .img-holder').height();
            $('.horizontalList .img-holder .img-holderInner').css('height', h);
