                                    ...
                                    <div class="catlist">
                                        ...
                                        if (isset($_REQUEST['search'])) {
                                            ...
                                            if (isset($_REQUEST['location']))
                                                ...
                                                echo '';
                                            ?>">
                                            <input type="hidden" name="city2" id="city2" value="<?php echo $_REQUEST['city']; ?>">	
                                        ...
                                        if (isset($_REQUEST['s'])) {
                                            ?>
                                            <input type="hidden" name="search_value1" id="search_value1" value="<?php echo $_REQUEST['s']; ?>">
                                        <?php } ?>	
        ...
        <script type="text/javascript">
            function load_more_data()
            {
                ...
                if (load_more_status == 'false') {
                    ...
                    $.post(url, {value: val, cat1: cat1, sub_cat1: sub_cat1, city1: city1, min_amount1: min_amount1, max_amount1: max_amount1, search_value1: search_value1, location: location, cityname: cityname, state_id_selection: state_id_selection,view:'list'}, function (response)
                    {
