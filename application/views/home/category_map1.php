                                ...
                                foreach ($product as $pro) { 
                                  // if($pro['product_id'] != $pro_id){
                                           ...
                                           <?php  }
                                            ...
                                            <td>AED <?php echo number_format($pro['product_price'],2); ?></td>
                                        </tr>
