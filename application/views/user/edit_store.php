                            ...
                            <div class="col-sm-9 ContentRight">
                                ...
                                <div class="row profile coverimg">
                                    ...
                                    <div class="col-sm-12 text-center">   
                                        ...
                                        <img src="<?php echo $store_cover_image; ?>" class="" onerror="this.src='<?php echo base_url(); ?>assets/upload/avtar.png'" id="upload_image" height="200px" width="1000px" alt="<?php echo $store[0]->store_name; ?>"/>
                                            ...
                                            <div class="userupdateform">
                                                ...
                                                <div class="col-sm-12">
                                                    <!--                                                    <div class="form-group row">
                                                                                                            ...
                                                                                                            <div class="col-sm-8">
                                                                                                                <input type="email" name="paypal_email_id" id="old_paypal_email_id" class="form-control" value="<?php echo $current_user[0]->paypal_email_id; ?>"/>
                                                                                                                <input type="hidden" name="old_paypal_email_id" id="old_paypal_email_id" class="form-control" value="<?php echo $current_user[0]->paypal_email_id; ?>"/>
                                                                                                            </div>                                                
                                                                                                        </div> -->
                                                    <div class="form-group row">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            ?>
                                                            <select class="form-control" id="category_id" name="category_id" <?php echo $disable_cat; ?> onchange="show_sub_cat(this.value);">
                                                    ...
                                                    <?php if ($current_user[0]->is_delete > 0) { ?>
                                                        <div class="form-group row sub_cat_block">
                                                            ...
                                                            <div class="col-sm-8">
                                                                ...
                                                                <select class="form-control" id="sub_category_id" name="sub_category_id" <?php echo $disable_cat; ?>>
                                                                    <option value="0" <?php echo ($store[0]->sub_category_id == 0) ? 'selected' : ''; ?>>Store Website</option>
                                                                </select>
                                                            </div>  
                                                        </div>
                                                        <div class="form-group row new_webiste">
                                                            <div class="col-sm-4">
                                                                <label>Website URL <span style="color:red;">*</span></label></label>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                <input type="url" class="form-control" placeholder="Website URL"  name="webiste_link" id="webiste_link" />
                                                                <input class="form-control" name="old_webiste_link"  id="old_webiste_link" type='hidden' value="<?php echo $store[0]->website_url; ?>" >
                                                            </div>  
                                                        </div>
                                                    <?php } elseif ($store[0]->category_id > 0) { ?>
...
<!--                <div class="modal fade center" id="replyModal" tabindex="-1" role="dialog"  aria-hidden="true">      
            ...
            <script>
                                                                ...
                                                                $("#profile_form").submit(function (event) {
                                                                    ...
                                                                    //        var paypal_email_id          = $('#paypal_email_id').val().trim();
                                                                    var store_name = $('#store_name').val().trim();
                                                                    var store_description = $('#store_description').val().trim();
                                                                    var meta_title = $('#meta_title').val().trim();
                                                                    var meta_description = $('#meta_description').text().trim();
                                                                    if ($('#webiste_link').length > 0) {
                                                                        var webiste_link = $('#webiste_link').val().trim();
                                                                    }
                                                                    //        var old_paypal_email_id        = $('#old_paypal_email_id').val().trim();
                                                                    var old_store_name = $('#old_store_name').val().trim();
                                                                    var old_store_description = $('#old_store_description').val().trim();
                                                                    var old_meta_title = $('#old_meta_title').val().trim();
                                                                    var old_meta_description = $('#old_meta_description').text().trim();
                                                                    if ($('#webiste_link').length > 0) {
                                                                        var old_webiste_link = $('#old_webiste_link').val().trim();
                                                                    }

                                                                    //        if(paypal_email_id==old_paypal_email_id && store_name==old_store_name && store_description==old_store_description && meta_title==old_meta_title && meta_description==old_meta_description) {
                                                                    if (store_name == old_store_name && store_description == old_store_description && meta_title == old_meta_title && meta_description == old_meta_description) {
                                                                        ...
                                                                        if ($('#category_id').val() == 0) {
                                                                            if (webiste_link == old_webiste_link) {
                                                                                $('.loader_display').hide();
                                                                                $(document).find('.response_message').html('You have not dentered website link.');
                                                                                $(document).find("#search_alert").modal('show');
                                                                                return false;
                                                                            }
                                                                ...
                                                                $('.edit-store-update').on('click', function () {
                                                                    $("#profile_form").valid();
                                                                });
