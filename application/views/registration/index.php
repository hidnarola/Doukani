                    ...
                    <div class="row">          
                        ...
                        <div class="col-sm-12 main category-grid">	
                            ...
                            <div class="col-sm-9 ContentRight loginpg">
                                ...
                                <h3>Registration</h3>
                                <form  name="registration" id="registration" action='<?php echo base_url(); ?>registration/index' method='post' enctype="multipart/form-data">
                                    <div class="col-sm-12 login-div regi-div">
                                        <div class="user-login">
                                            ...
                                            <?php if($this->session->userdata('store_name_create')){ ?>
                                            ...
                                            <div class="form-group">   
                                                <select id="user_role" name="user_role" class="select2 form-control" >
                                                    ...
                                                    <option value="storeUser">Store User</option>
                                                    <?php //echo '<option value="offerUser">Offer User</option>'; ?>
                                                </select>
                                            </div>
                                            <?php }else{ ?>
                                            <div class="form-group" style="display: none;">   
                                                <select id="user_role" name="user_role" class="select2 form-control" >
                                                    <option value="storeUser" selected="selected">Store User</option>
                                                </select>
                                            </div>
                                            <?php } ?>
                                            <?php
                                            $store_display = 'style="display: none;"';
                                            if($this->session->userdata('store_name_create')){
                                                $store_display = '';
                                            }
                                            ?>
<!--                                            <div class="form-group classified_hide_show_div">   
                                                <div class="gender">
                                                    <label><input type="radio" value="1" name="gender" id="gender1" checked />Male</label>
                                                    <label><input type="radio" value="0" name="gender" id="gender2" />Female</label>
                                                </div>	
                                                <label class="error"></label>
                                            </div>-->
                                            
                                            
                                            <div class="form-group store_hide_show_div" <?php echo $store_display; ?>>     
                                                <input type="text" class="form-control" placeholder="Store Name" name="store_name" id="store_name" value="<?php if($this->session->userdata('store_name_create')){ echo $this->session->userdata('store_name_create'); } ?>" />
                                            ...
                                            <div class="form-group store_hide_show_div" <?php echo $store_display; ?>>     
                                                ...
                                                <br>
                                                <span id="store_domain_status" class="store_domain_status"></span>
                                            </div>
