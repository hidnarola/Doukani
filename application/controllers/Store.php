...
class Store extends My_controller {
    ...
    public function store($store_domain) {
        ...
        $data['page_title'] =   '';
        if($store_domain!='') {
            $where  = " where store_domain ='" . $store_domain . "' and store_status=0 and store_is_inappropriate='Approve'";
            ...
            if(!empty($store)) {
                ...
                $query  = " product_id from product where product_posted_by='".$store[0]->store_owner."' and is_delete=0 and product_deactivate IS NULL and product_is_inappropriate='Approve' and product_for='store' ";
