...
class Home extends My_controller {
    ...
    public function index($slug = NULL) {
        ...
        $full_url = $first_name.after_subdomain;
        ...
        if($_SERVER['HTTP_HOST']==$full_url) {
            ...
            $this->individual_store($first_name,$store);
                ...
                if($slug==NULL) {
                      ...
                      //Home Page 
                       // getting the banners for home page
                        ...
                        $feature_banners         = $this->dbcommon->getBanner_forCategory('sidebar',"'content_page','all_page'",null,null);                
                ...
                {
                    //get 1st character to check slug is for product,category,sub-category,seller
                    $get_char = strstr($slug, '_',true);
                  
                     if(isset($_GET['view']) && $_GET['view']=='map' && ($get_char=='C' || $get_char=='SC'))
                        $this->category_map($slug);
                     elseif($get_char=='C' || $get_char=='SC')
                        $this->category($slug);
                    //call seller  - User
                     elseif($get_char=='U') {
                        echo 'hello';
    ...
    public function category($slug = NULL) {
        ...
        $get_first_chr = strstr($slug, '_',true);
        $data = array();
		$data = array_merge($data, $this->get_elements());
        $data['slug'] =   $slug;
        if($get_first_chr == 'C') {
            ...
            if(sizeof($category)>0) {
                ...
                $subcat_id  =   NULL;
                $cat_name   =   $category[0]['catagory_name'];
            }
            else{
        ...
        elseif($get_first_chr == 'SC') {
          ...
          $product = $this->dbcommon->get_product_by_categories($cat_id, $subcat_id, null, 12);
			...
			if ($subcat_id != null) {
				$breadcrumb = array(
					'Home' => base_url(),
					$category[0]['catagory_name'] => base_url(). $category[0]['category_slug'].$linkk,
					$subcategory[0]['sub_category_name'] => '#'
				);
			}
    ...
    public function search() {
        ...
        $data['between_banners'] = $between_banners;
            ...
            if ($search_value != "") {
                $where .= "AND (
                            ...
                            OR sc.sub_category_name LIKE '%".$search_value."%'
                            ) and p.is_delete=0";
            }
            ...
            $query1 = "SELECT p.product_id,p.product_posted_by,p.product_name,p.product_image,p.product_price,p.product_status,p.product_is_inappropriate ,p.product_total_views, p.product_total_favorite,if(u.nick_name!='',u.nick_name,u.username) as username1,p.product_is_sold,
                    ...
                    FROM product as p , category as c , user as u,sub_category as sc  where p.category_id=c.category_id and p.sub_category_id =sc.sub_category_id  and u.user_id = p.product_posted_by
                    and p.is_delete = 0 and p.product_is_inappropriate='Approve' and p.product_deactivate is null ";
            ...
            $query = "SELECT p.product_id,p.product_posted_by,p.product_name,p.product_image,p.product_price,p.product_status,p.product_is_inappropriate ,p.product_total_views, p.product_total_favorite,if(u.nick_name!='',u.nick_name,u.username) as username1,p.product_is_sold,
                    c.catagory_name, u.username, u.profile_picture, u.facebook_id,u.twitter_id,u.google_id,p.product_total_likes,p.product_slug
                    FROM product as p , category as c , user as u,sub_category as sc  where p.category_id=c.category_id and p.sub_category_id =sc.sub_category_id and u.user_id = p.product_posted_by
                    and p.is_delete = 0 and p.product_is_inappropriate='Approve' and p.product_deactivate is null ";
        ...
        if($_SERVER['HTTP_HOST']==$full_url) {
            ...
            if(!empty($store)) {    
                ...
                $data['store'] = $store;
                $data['store_owner']        = $store[0]->store_owner;
                ...
                $query_cnt  = " product_id from product where product_posted_by='".$store[0]->store_owner."' and is_delete=0 and product_deactivate IS NULL and product_is_inappropriate='Approve'";
                ...
                $query1 .= $where.' and product_posted_by='.$store[0]->store_owner.' group by p.product_id';
            ...
            $query1 .= $where.' group by p.product_id';

            $prod           = $this->db->query($query1);
            $total_product  = $prod->num_rows($prod);
            // echo $this->db->last_query();
            $where .= " group by `product_id`";
            $where .= " order by `product_posted_time` desc limit 0,12";
	...
	public function more_search() {
        ...
        if ($search_value != "") {
		 ...
		 $query1 = "SELECT p.product_id,p.product_posted_by,p.product_name,p.product_image,p.product_price,p.product_status,p.product_is_inappropriate ,p.product_total_views, p.product_total_favorite,if(u.nick_name!='',u.nick_name,u.username) as username1,u.facebook_id,u.twitter_id,u.google_id,c.catagory_name, u.username, u.profile_picture,p.product_is_sold,p.product_total_likes,p.product_slug  FROM product as p , category as c , user as u,sub_category as sc  where p.category_id=c.category_id and p.sub_category_id=sc.sub_category_id and u.user_id = p.product_posted_by and p.is_delete = 0 and p.product_is_inappropriate='Approve' and p.product_deactivate is null ";
        ...
        $query = "SELECT p.product_id,p.product_posted_by,p.product_name,p.product_image,p.product_price,p.product_status,p.product_is_inappropriate ,p.product_total_views, p.product_total_favorite,if(u.nick_name!='',u.nick_name,u.username) as username1,u.facebook_id,u.twitter_id,u.google_id,p.product_is_sold,
                c.catagory_name, u.username, u.profile_picture,p.product_total_likes,p.product_slug FROM product as p , category as c , user as u,sub_category as sc  where p.category_id=c.category_id and p.sub_category_id=sc.sub_category_id and u.user_id = p.product_posted_by
                and p.is_delete = 0 and p.product_is_inappropriate='Approve' and p.product_deactivate is null ";
		//p.product_is_inappropriate != 'Inappropriate'
        ...
        if($_SERVER['HTTP_HOST']==$full_url) {
            ...
            if(!empty($store)) {  
                ...
                $data["html"]           = $this->load->view('store/more_search_store_products', $data, TRUE);
            ...
            //echo $this->db->last_query();   
            $where .= " group by `product_id`";
            $where .= " order by `product_posted_time` desc limit ".$start.",12";
	...
	public function advanced_search() {
		...
		if(isset($_POST['default']) || isset($_POST['vehicle_submit']) || isset($_POST['real_estate_submit']) || isset($_POST['shared_submit']) ) {
			...
			c.catagory_name, u.username, u.profile_picture,u.facebook_id,u.twitter_id,u.google_id,p.product_is_sold,p.product_slug  FROM product as p , category as c , user as u,product_vehicles_extras as v,product_realestate_extras r  where p.category_id=c.category_id and u.user_id = p.product_posted_by and p.is_delete = 0 and p.product_is_inappropriate='Approve' and p.product_deactivate is null $where ";
			
			$prod 			= $this->db->query($query1);
			$total_product  = $prod->num_rows($prod);
						
			//$where .= " order by `admin_modified_at` desc limit 12";
            $where .= " order by `product_posted_time` desc limit 12";
			...
			c.catagory_name, u.username, u.profile_picture,u.facebook_id,u.twitter_id,u.google_id,p.product_is_sold,p.product_total_likes ,p.product_slug FROM product as p , category as c , user as u,product_vehicles_extras as v,product_realestate_extras r  where p.category_id=c.category_id and u.user_id = p.product_posted_by and p.is_delete = 0 and p.product_is_inappropriate='Approve' and p.product_deactivate is null $where ";
	...
	public function load_more_advanced_search() {
		...
		$query1 = "SELECT p.product_id,p.product_posted_by,p.product_name,p.product_image,p.product_price,p.product_status,p.product_is_inappropriate ,p.product_total_views, p.product_total_favorite,if(u.nick_name!='',u.nick_name,u.username) as username1,p.product_is_sold,
				c.catagory_name, u.username, u.profile_picture,u.facebook_id,u.twitter_id,u.google_id,p.product_total_likes,p.product_slug  FROM product as p , category as c , user as u,product_vehicles_extras as v,product_realestate_extras r  where p.category_id=c.category_id and u.user_id = p.product_posted_by
   ...
   public function search_by_city() {
    ...
    public function category_map($slug = NULL) {
        ...
        elseif($get_first_chr == 'SC') {
           ...
           $count = $this->dbcommon->get_products_by_cat_num($cat_id, $subcat_id);    
            $url = base_url() . $slug.'/?view=map'.$order_option;
          ...
          $product = $this->dbcommon->get_product_by_categories($cat_id, $subcat_id, NULL, $config["per_page"], $offset);
            ...
            if ($cat_id == 7) {
                $product = $this->dbcommon->get_vehicle_products($cat_id, $subcat_id, NULL, $config["per_page"], $offset);
            }
            if ($cat_id == 8) {
                $product = $this->dbcommon->get_real_estate_products($cat_id, $subcat_id,NULL, $config["per_page"], $offset);
            }
	...
	public function more_favorite() {
        ...
        $query = "SELECT p.product_id,p.product_name,p.product_image,p.product_price,p.product_status,p.product_is_inappropriate ,p.product_total_views, p.product_total_favorite,p.product_posted_by,if(u.nick_name!='',u.nick_name,u.username) as username1,p.product_is_sold,u.facebook_id,u.twitter_id,u.google_id,c.catagory_name, u.username, u.profile_picture  FROM product as p , category as c , user as u  where p.category_id=c.category_id and u.user_id = p.product_posted_by and p.is_delete = 0 and p.product_is_inappropriate = 'Approve' and p.product_deactivate is null and p.product_total_favorite > 0 order by `product_posted_time` desc limit $start,12";
    ...
    public function item_details($product_slug = null) {
        
       $product = $this->dbcommon->get_product_slugwise($product_slug);
       ...
       { 
        ...
        $rand       = 'rand';
         ...
         if($first_name!='doukani') 
         {
            ...
            if(!empty($store)) {
                ...
                $related_product = $this->dbcommon->get_product_by_categories($cat_id, $subcat_id, $pro_id, 8,'',$rand,$store_user_id);            
         }
         else
         {
			...
			else
			{
				...
				if (isset($_POST['reply_submit'])) {
					...
					if (send_mail($user_email->email_id, 'Reply for your product: '.$productName, $new_data)){		
                        ...
                        //$this->item_details($product_slug);
		...
		//                $this->email->reply_to('oscar@treatmo.com', 'treatmo');
				...
				$breadcrumb = array(
					'Home' => base_url(),
					$product->catagory_name => base_url() . $category[0]['category_slug'],
					$product->sub_category_name => base_url() . $subcategory[0]['sub_category_slug'],
...
//                $this->email->reply_to('oscar@treatmo.com', 'treatmo');
    ...
    function individual_store($first_name,$store) {
          ...
          if(!empty($store)) {
                ...
                // $store_user_last_logged_in =  $this->dbcommon->dateDiff(date('y-m-d H:i:s'),$store_user[0]->last_logged_in);
                // $data['store_user_last_logged_in'] =  $store_user_last_logged_in;
                ...
                $listing            = $this->dbcommon->get_my_listing($store[0]->store_owner,$start=0,$limit=15);
                $data['listing']    = $listing;

                $total_product      = $this->dbcommon->get_my_listing_count($store[0]->store_owner);
                ...
                //redirect('store/store/'.$store[0]->store_domain);
                $this->session->set_userdata('message_follow_unfllow','Your message sent successfully');
                header('Location:'.HTTPS.$store[0]->store_domain.'.'.website_url.'home');
    ...
    public function load_more_storelisting() {
          ...
          $total_product= $this->dbcommon->get_my_listing_count($user_id);
          $listing      = $this->dbcommon->get_my_listing($user_id,$start,15);
          ...
          $arr['listing']   =   $listing;
          $arr["html"]      =   $this->load->view('store/more_store_products',$arr,TRUE);
          $arr["val"]       =   $hide;
          $arr["total_product"] = $total_product;
    ...
    function get_store_products() {
        ...
        $start      = 0;        
        $hide       = "false";
        $total_product      = $this->dbcommon->get_my_listing_count($user_id,$search);
        ...
        $products   = $this->dbcommon->get_my_listing($user_id,$start,15,$search);
        //echo $this->db->last_query();
        $main_data['products'] =   $products;
