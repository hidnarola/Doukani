...
$config['cookie_prefix'] = "doukani_";
$config['cookie_domain'] = ".doukani.com";
$config['cookie_path'] = "/";
$config['cookie_secure'] = FALSE;
 //Sesion expires after 2 weeks
$config['sess_expiration'] = 20160;
...
$config['facebook']['redirect_url'] = 'https://doukani.com/login/facebook_login';
...
function __autoload($class)
{
 if(strpos($class, 'CI_') !== 0)
 {
	...
	@include_once( APPPATH . 'hooks/'. $class . '.php' );
 }
}