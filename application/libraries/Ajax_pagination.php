...
//          $this->items_per_page = $this->default_ipp;
        ...
        if($this->num_pages > 10)
        {
            ...
            {
                if($this->range[0] > 2 And $i == $this->range[0]) $this->return .= " <span class='inactive'> ... </span> ";
                ...
                if($this->range[$this->mid_range-1] < $this->num_pages-1 And $i == $this->range[$this->mid_range-1]) $this->return .= " <span class='inactive'> ... </span> ";
            }
